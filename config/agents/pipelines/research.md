...
2. Researcher maps what is already known from local instructions, source code, configuration, prior decisions, and the current runtime.
...
4. Researcher records a compact evidence ledger: source, date or version, claim supported, relevance, and limitation.
